jQuery( document ).ready( function() {
    ...
    jQuery( document ).on( 'click', '.sv100_sv_header .sv100_sv_navigation_mobile_menu_toggle', function() {
        ...
        jQuery( '.sv100_sv_header .sv100_sv_navigation_sv_header_primary' ).toggleClass( 'open' );
    });

    /* Opens and closes menus */
    jQuery( document ).on( 'click', '.sv100_sv_header .sv100_sv_navigation_sv_header_primary.open a', function() {
