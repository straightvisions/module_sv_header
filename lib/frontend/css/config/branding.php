...
$properties['-webkit-justify-content'] 	= $setting->prepare_css_property_responsive($branding_alignment);
$properties['order'] 			= $setting->prepare_css_property_responsive($branding_order);
$properties['-webkit-order'] 			= $setting->prepare_css_property_responsive($branding_order);
