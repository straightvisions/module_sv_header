<div class="sv_setting_subpage">
    ...
    <div class="sv_setting_flex">
		<?php echo $module->get_setting( 'menu_padding_mobile' )->form(); ?>
    </div>
    ...
    <div class="sv_setting_flex">
		<?php
			echo $module->get_setting( 'menu_item_margin_mobile' )->form();
			echo $module->get_setting( 'menu_item_padding_mobile' )->form();
		?>
    </div>
	...
	<div class="sv_setting_flex">
		<?php
			echo $module->get_setting( 'border_style_menu_item_mobile' )->form();
			echo $module->get_setting( 'border_radius_menu_item_mobile' )->form();
			echo $module->get_setting( 'border_color_menu_item_mobile' )->form();
		?>
	</div>
	<div class="sv_setting_flex">
		<?php
			echo $module->get_setting( 'border_width_menu_item_mobile' )->form();
		?>
	</div>
    ...
    <h3 class="divider"><?php _e( 'Padding', 'sv100' ); ?></h3>
    <div class="sv_setting_flex">
		<?php echo $module->get_setting( 'sub_padding_mobile' )->form(); ?>
    </div>
    <h3 class="divider"><?php _e( 'Background', 'sv100' ); ?></h3>
    <div class="sv_setting_flex">
		<?php
    ...
    <div class="sv_setting_flex">
		<?php
			echo $module->get_setting( 'sub_item_margin_mobile' )->form();
			echo $module->get_setting( 'sub_item_padding_mobile' )->form();
		?>
    </div>
	...
	<div class="sv_setting_flex">
		<?php
			echo $module->get_setting( 'border_style_menu_sub_item_mobile' )->form();
			echo $module->get_setting( 'border_radius_menu_sub_item_mobile' )->form();
			echo $module->get_setting( 'border_color_menu_sub_item_mobile' )->form();
		?>
	</div>
	<div class="sv_setting_flex">
		<?php
			echo $module->get_setting( 'border_width_menu_sub_item_mobile' )->form();
		?>
	</div>
    ...
    <div class="sv_setting_flex">
		<?php echo $module->get_setting( 'menu_icon_size' )->form(); ?>
    </div>
    <div class="sv_setting_flex">
		<?php
			echo $module->get_setting( 'menu_icon_closed' )->form();
			echo $module->get_setting( 'menu_icon_open' )->form();
		?>
    </div>
    <div class="sv_setting_flex">
		<?php
			echo $module->get_setting( 'menu_icon_closed_color' )->form();
			echo $module->get_setting( 'menu_icon_open_color' )->form();
		?>
    </div>
</div>